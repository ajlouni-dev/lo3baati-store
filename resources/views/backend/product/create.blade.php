                    ...
                    <div class="card-body">
                        ...
                        <form id="product-form">
                            <div class="row">
                                ...
                                <input type="hidden" name="type" class="form-control selectpicker" id="type" value="standard">
                                <div class="col-md-4">
                                    <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                          <select name="brand_id" class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" title="{{trans('file.Select Brand...')}}">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                          <select name="category_id" required class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" title="{{trans('file.Select Category...')}}">
                                        ...
                                        <div class="col-md-4 form-group">
                                                ...
                                                <div class="input-group">
                                                  <select required class="form-control selectpicker" name="unit_id">
                                                    <option value="" disabled selected>{{trans('file.Select Product Unit...')}}</option>
