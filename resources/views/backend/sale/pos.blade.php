            ...
            <div class="col-md-6">
                <div class="card">
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                      <div class="form-group">
                                          <input type="text" name="created_at" class="form-control date" placeholder="{{trans('file.Choose date')}}" onkeyup='saveValue(this);'/>
                                      </div>
                                    </div>
                                    <div class="col-md-3">
                                      <div class="form-group">
                                          <input type="text" id="reference-no" name="reference_no" class="form-control" placeholder="{{trans('file.Type reference number')}}" onkeyup='saveValue(this);'/>
                                      </div>
                                    ...
                                    @if($lims_pos_setting_data->is_table)
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <select required id="table_id" name="table_id" class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" title="{{trans('file.Select table...')}}">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group pos">
                                                @if($customer_active)
                                                <select required name="customer_id" id="customer_id" class="selectpicker form-control" data-live-search="true" title="{{trans('file.Select customer...')}}" style="width: 100px">
                                                <?php
                                                  $deposit = [];
                                                  $points = [];
                                                ?>
                                                ...
                                                <?php
                                                  ...
                                                  $points = [];
                                                ?>
                                                <select required name="customer_id" id="customer_id" class="selectpicker form-control" data-live-search="true" title="{{trans('file.Select customer...')}}">
                                                @foreach($lims_customer_list as $customer)
                                                    @php
                                                      $deposit[$customer->id] = $customer->deposit - $customer->expense;
                                    ...
                                    <div class="col-md-12">
                                        <div class="search-box form-group">
                                            <input type="text" name="product_code_name" id="lims_productcodeSearch" placeholder="{{trans('file.Scan/Search product by name/code')}}" class="form-control"  />
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                    ...
                    <div class="payment-options">
                        ...
                        @endif
                        <div class="column-5 hide-by-firas">
...
$("#draft-btn").on("click",function(){
    ...
    if (rownumber < 0) {
        alert("{{trans('file.Please insert product to order table!')}}")
    }
    else
        $('.payment-form').submit();
});
...
$('input[name="paid_amount"]').on("input", function() {
    if( $(this).val() > parseFloat($('input[name="paying_amount"]').val()) ) {
        alert("{{trans('file.Paying amount cannot be bigger than recieved amount')}}");
        $(this).val('');
    }
