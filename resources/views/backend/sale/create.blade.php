                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="created_at" class="form-control date" placeholder="{{trans('file.Choose date')}}"/>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                ...
                                <div class="row mt-3">
                                    <div class="col-md-12">
                                        ...
                                        <div class="search-box input-group">
                                            ...
                                            <input type="text" name="product_code_name" id="lims_productcodeSearch" placeholder="{{trans('file.Please type product code and select...')}}" class="form-control" />
                                        </div>
                                    </div>
                                </div>
                                <div class="row mt-5">
