...
<head>
  ...
  @endif
  <link rel="stylesheet" href="<?php echo asset('css/custom.css?v=3') ?>">
  @else
  <link rel="icon" type="image/png" href="{{url('../../logo', $general_setting->site_logo)}}" />
  <title>{{$general_setting->site_title}}</title>
  <meta name="description" content="">
            ...
            <li class="nav-item" id="notification-icon">
              ...
              <ul class="right-sidebar">
                <li class="notifications">
                  <a href="{{route('report.qtyAlert')}}" class="btn btn-link"> {{$alert_product}} {{ trans('file.product exceeds alert quantity') }}</a>
                </li>
          ...
          <div class="modal-body">
            ...
            <div class="row">
              ...
              <div class="col-md-6 form-group">
                ...
                <select name="expense_category_id" class="selectpicker form-control" required data-live-search="true" data-live-search-style="begins" title="{{trans('file.Select Expense Category...')}}">
