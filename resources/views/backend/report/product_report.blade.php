                    ...
                    <div class="form-group row">
                        ...
                        <div class="d-tc">
                            <div class="input-group">
                                <input type="text" class="daterangepicker-field form-control" value="{{$start_date}} {{trans('file.To')}} {{$end_date}}" required />
        ...
        <table id="product-report-table" class="table table-hover" style="width: 100%">
            <thead>
                <tr>
                    ...
                    <th>{{trans('file.Returned Qty')}}</th>
                    <th>{{trans('file.Purchase Returned Amount')}}</th>
                    <th>{{trans('file.Purchase Returned Qty')}}</th>
