                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select required name="warehouse_id" class="selectpicker form-control" data-live-search="true" title="{{trans('file.Select warehouse...')}}">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select name="supplier_id" class="selectpicker form-control" data-live-search="true" title="{{trans('file.Select supplier...')}}">
