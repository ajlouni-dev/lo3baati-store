    ...
    public function posSale()
    {
        ...
        if($role->hasPermissionTo('sales-add')) {
            ...
            $lims_product_list = Cache::remember('product_list', 60*60*24, function () {
                return Product::ActiveFeatured()->whereNull('is_variant')->orderBy('created_at','desc')->get();
            });
            ...
            $lims_product_list_with_variant = Cache::remember('product_list_with_variant', 60*60*24, function () {
                return Product::ActiveFeatured()->whereNotNull('is_variant')->orderBy('created_at','asc')->get();
            });
